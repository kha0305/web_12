...
async def create_sample_data():
    ...
    print("\nLogin credentials:")
    print("\n📋 PATIENTS:")
    print("  Email: patient1@test.com | Password: patient123")
    print("  Email: patient2@test.com | Password: patient123")
    print("  Email: patient3@test.com | Password: patient123")
    print("\n👨‍⚕️ DOCTORS:")
    print("  Email: doctor1@test.com | Password: doctor123")
    print("  Email: doctor2@test.com | Password: doctor123")
    print("  Email: doctor3@test.com | Password: doctor123")
    print("\n👔 DEPARTMENT HEAD:")
    print("  Email: departmenthead@test.com | Password: dept123")
    print("\n🔐 ADMIN:")
    print("  Email: admin@medischedule.com | Password: admin123")
    print("="*60)
